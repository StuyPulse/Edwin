...
import com.stuypulse.stuylib.file.FRCLogger;
...
public class RobotContainer {
  ...
  //TODO: get file target from SmartDashboard
  private FRCLogger logger = new FRCLogger(Filesystem.getDeployDirectory().toString(), "palmetto");
  /**
  ...
  public RobotContainer() {
    ...
    logger.registerLoggable(climber);
    logger.registerLoggable(intake);
    logger.registerLoggable(controlPanel);
    controlPanel.setDefaultCommand(new ControlPanelManualControlCommand(controlPanel));
  }

  public FRCLogger getLogger() {
    return logger;
  }
