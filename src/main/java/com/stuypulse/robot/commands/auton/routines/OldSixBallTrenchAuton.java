...
// new DrivetrainMovementCommand(robot.getDrivetrain(), 0,
// AutoSettings.DISTANCE_FROM_START_TO_TRENCH_IN_FEET +
// DISTANCE_TO_ACQUIRE_TWO_BALLS_IN_FEET).setMaxSpeed(DRIVETRAIN_SPEED_LIMIT).withTimeout(3),
...
// new DrivetrainGoalCommand(robot.getDrivetrain(),
// Alignment.TRENCH_DISTANCE).withTimeout(3.5),
...
// new DrivetrainMovementCommand(robot.getDrivetrain(), 0,
// DISTANCE_TO_ACQUIRE_THIRD_BALL_IN_FEET).setMaxSpeed(DRIVETRAIN_SPEED_LIMIT).withTimeout(2.0),

// new LEDSetCommand(robot.getLEDController(), LEDColor.BLUE_SOLID),
// new DrivetrainGoalCommand(robot.getDrivetrain(),
// Alignment.TRENCH_DISTANCE).withTimeout(4),
