...
public class RedSixBallTwoTrenchOneTrenchAutonCommand extends SequentialCommandGroup {
    public RedSixBallTwoTrenchOneTrenchAutonCommand(Drivetrain drivetrain, Shooter shooter, Funnel funnel, Chimney chimney, Intake intake, LEDController controller) {
        ...
        addCommands(
            ...
            new DrivetrainAlignmentCommand(drivetrain, new DrivetrainGoalAligner(Constants.Alignment.TRENCH_DISTANCE)).setSpeed(Alignment.Speed.LIMELIGHT_MAX_SPEED).setNeverFinish().withTimeout(4.5),
            ...
            new DrivetrainAlignmentCommand(drivetrain, new DrivetrainGoalAligner(Constants.Alignment.TRENCH_DISTANCE)).setSpeed(Alignment.Speed.LIMELIGHT_MAX_SPEED).setNeverFinish().withTimeout(5),
