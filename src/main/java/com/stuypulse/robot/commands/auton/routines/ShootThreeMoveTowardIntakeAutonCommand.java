...
public class ShootThreeMoveTowardIntakeAutonCommand extends SequentialCommandGroup {
    ...
    public ShootThreeMoveTowardIntakeAutonCommand(Drivetrain drivetrain, Shooter shooter, Intake intake, Funnel funnel, Chimney chimney, LEDController controller) {
        ...
        addCommands(
            ...
            new DrivetrainGoalCommand(drivetrain, Constants.Alignment.INITATION_LINE_DISTANCE).withTimeout(2.0),
