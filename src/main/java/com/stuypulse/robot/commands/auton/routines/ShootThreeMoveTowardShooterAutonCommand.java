...
public class ShootThreeMoveTowardShooterAutonCommand extends SequentialCommandGroup {
    ...
    public ShootThreeMoveTowardShooterAutonCommand(Drivetrain drivetrain, Shooter shooter, Intake intake, Funnel funnel,
        ...
        addCommands(
                ...
                new LEDSetCommand(Color.PURPLE_SOLID, controller), new IntakeAcquireSetupCommand(intake));
    }
