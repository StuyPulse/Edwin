...
public class ShootEightInnerGoalThreeTrenchTwoRdvsAutonCommand extends SequentialCommandGroup {
    public ShootEightInnerGoalThreeTrenchTwoRdvsAutonCommand(Drivetrain drivetrain) {
        ...
        addCommands(new DrivetrainMovementCommand(drivetrain, 0, Constants.DISTANCE_FROM_BALL_TO_BALL * 3));
